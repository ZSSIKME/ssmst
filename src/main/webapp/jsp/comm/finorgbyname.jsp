    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-12 input-group input-group-lg">
                <input class="text form-control" placeholder="请输入要查询的社团名字" id="findactname" style="width: 450px">
                <input class="text form-control" placeholder="请输入要查询的社团名字" id="findactstuname" style="width: 450px">
                <button class="btn btn-info btn-lg" role="group" onclick="findorg($('#findactname').val(),$('#findactstuname').val())">查询</button>
            </div>
            <table class="table table-hover">
                ...
                <c:forEach items="${orgfind}" var="org">
                    <tr>
                        <td>${org.id}</td>
                        <td>${org.name}</td>
